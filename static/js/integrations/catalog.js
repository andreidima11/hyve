...
async function persistIntegrationEnabled(slug, configKey, enabled) {
...
function applyCatalogEnabledToCheckboxes() {
...
;
function _integrationIconHtml(entry) {
...
function _integrationRowHtml(entry) {
...
export async function loadIntegrationCatalog(force = false) {
    if (getIntegrationCatalog().length && !force)
