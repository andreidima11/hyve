 ...
 * }} DashboardWidgetActionDeps */

/** @type {DashboardWidgetActionDeps | null} */
let _deps = null;
...
export function onDashboardBrightnessInput(event, widgetId) {
    ...
    _brightnessDebounceTimer = setTimeout(() => sendBrightness(widgetId, pct), 220);
}
...
export async function onDashboardLockAction(widgetId, action) {
    ...
    try {
        ...
        if (!tryFastPathForEntities([widget.entity_id])) renderDashboard();
    } catch (e) {
