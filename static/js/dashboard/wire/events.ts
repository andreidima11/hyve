...
import {
    ...
    onDashboardLightColorChange,
    onDashboardLightColorTempInput,
    onDashboardLightColorTempChange,
    onDashboardLightHueInput,
    onDashboardLightHueChange,
...
export function wireDashboardEvents(): void {
    initDashboardEventBindings({
        ...
        lightColorChange: ({ event, widgetId }) => onDashboardLightColorChange(event, widgetId),
        lightColorTempInput: ({ event, widgetId }) => onDashboardLightColorTempInput(event, widgetId),
        lightColorTempChange: ({ event, widgetId }) => onDashboardLightColorTempChange(event, widgetId),
        lightHueInput: ({ event, widgetId }) => onDashboardLightHueInput(event, widgetId),
        lightHueChange: ({ event, widgetId }) => onDashboardLightHueChange(event, widgetId),
