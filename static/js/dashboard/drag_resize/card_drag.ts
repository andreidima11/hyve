...
import {
    ...
    _asPointerEvent,
    _asHTMLElement,
    _nestedInteractiveTarget,
    _touchHoldGate,
    _scheduleDashboardCloneMove,
    _errMsg,
    findWidget,
    getCache,
    getCurrentPageId,
...
import {
    ...
    _panelWidgets,
    _findDashboardSwapCandidate,
    _resolveOverlaps,
    _normalizePanelLayout,
    _clampColStartForSpan,
    _findDashboardRootSwapCandidate,
    _resolveDashboardRootOverlaps,
    _normalizeDashboardRootLayout,
    _applyDashboardRootRect,
    _persistDashboardRootRect,
    renderDashboardWithFlip,
} from './grid_geometry.js';
import type { DashboardDragRect, DashboardMoveState, DashboardSortableState } from '../../types/drag_resize.js';
...
export async function commitDashboardWidgetMove(st: DashboardMoveState | DashboardSortableState) {
