...
export async function saveDashboardHeader() {
    ...
    if (_pageEditorMode === 'create') {
        ...
        try {
            ...
            showToast(e.message || d.t('dashboard.page_create_error'), 'error');
        }
        return;
    }
    ...
    try {
        ...
        showToast(e.message || (d.t('dashboard.page_save_error') || 'Could not save page'), 'error');
    }
}
...
export async function deleteDashboardPage() {
    ...
    try {
        ...
        showToast(e.message || (d.t('dashboard.page_delete_error') || 'Could not delete page'), 'error');
    }
}
