...
export function createDashboardYamlEditor(deps) {
    ...
    async function openDashboardYamlEditor() {
        ...
        try {
            ...
            setStatus(e.message || t('dashboard.load_error'), 'error');
            setValue('# ' + (e.message || t('dashboard.load_error')));
        }
    }
    ...
    async function reloadDashboardYaml() {
        ...
        try {
            ...
            setStatus(e.message || t('common.error'), 'error');
        }
    }
    ...
    async function saveDashboardYaml() {
        ...
        try {
            ...
            setStatus(e.message || t('dashboard.yaml_save_error'), 'error');
            showToast(e.message || t('dashboard.yaml_save_error'), 'error');
        }
    }
