...
import { MEM_LOG_PAGE_SIZE, memoryState, memoryUiState } from './state.js';
...
export function renderExtractionExamples(examples) {
    memoryState.extractionExamples = Array.isArray(examples) ? examples : [];
