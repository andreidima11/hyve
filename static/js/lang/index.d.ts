...
export declare function mergeBundledTranslations(payload: Record<string, unknown>): void;
export declare function loadBundledTranslations(lang: string): Promise<void>;
...
export declare function localeTag(lang?: string): string;
