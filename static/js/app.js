...
window.addEventListener('DOMContentLoaded', () => {
    ...
    initConfigEventBindings({
        ...
        showUpdateReleaseNotes: (_event, el) => showUpdateReleaseNotes(el.dataset.configTarget || 'hyve'),
