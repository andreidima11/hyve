...
export function finalizeStoppedStreamingBubble(): void {
...
export function setSendButtonState(streaming: boolean): void {
...
export function getStreamAbortController(): AbortController | null {
    return _currentAbortController;
}

export function setStreamAbortController(controller: AbortController | null): void {
    _currentAbortController = controller;
}

export function clearStreamAbortController(): void {
    _currentAbortController = null;
}
