...
export class HyveviewClimateCard extends HyveviewCardBase {
    constructor() {
        ...
        this._currentUnitEl = null;
        this._modeLabelEl = null;
        this._modeOptions = null;
        this._stateLineEl = null;
        this._targetEl = null;
    }
    ...
    setState(entity) {
        ...
        if (entity.entity_id && activeId && entity.entity_id !== activeId)
            return;
        ...
        const active = (w._climateActiveEntity && typeof w._climateActiveEntity === 'object'
            ? w._climateActiveEntity : {});
        active.attributes = {
            ...(active.attributes || {}),
            ...(entity.attributes || {}),
        };
        if (entity.state !== undefined)
            active.current_state = entity.state;
        if (entity.available !== undefined)
            active.available = entity.available !== false;
    ...
    setActiveSlide(index, entity) {
        ...
        this._cacheSlots();
        this._patchFields((w._climateActiveEntity || null));
        this._mirrorParent();
    }
    _patchFields(entity) {
        if (!entity)
