...
export class HyveviewLockCard extends HyveviewCardBase {
    ...
    _applyState() {
        ...
        if (this._lockBtn)
            this._lockBtn.setAttribute('data-active', isLocked ? 'true' : 'false');
        if (this._unlockBtn)
            this._unlockBtn.setAttribute('data-active', isUnlocked ? 'true' : 'false');
