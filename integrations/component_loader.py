...
def discover_integration_classes(
    *,
    ...
    """Unified discovery: ``components/`` + ``custom_components/``."""
    del providers_dir  # legacy flat providers removed; kept for call-site compat
    return discover_component_classes(force=force)


def get_component_entity_class(slug: str) -> type[BaseEntity] | None:
    """Load a single bundled/custom component class by slug."""
