...
/**
 * Foreground Service that keeps a WebSocket connection alive to the Hyve server.
 * 
 ...
 *
 * The service shows a minimal persistent notification ("Connected to Hyve")
 * and automatically reconnects the WebSocket on network changes.
 */
class NotificationService : Service() {

    companion object {
        private const val TAG = "HyveService"
        private const val SERVICE_CHANNEL_ID = "hyve_service"
        private const val SERVICE_CHANNEL_NAME = "Hyve Connection"
    ...
    private fun createServiceChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = "Keeps Hyve connected for instant notifications"
                setShowBadge(false)
            }
