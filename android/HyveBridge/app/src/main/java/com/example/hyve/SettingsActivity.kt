 ...
 * - The `hyve://settings` deep link on the login page
 */
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spannable.setSpan(ForegroundColorSpan(Color.parseColor("#38bdf8")), 2, fullText.length, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
